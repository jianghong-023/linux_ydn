                        ...
                        void *                p_new_cb_data) // p_dvbpsi,NewSubtable ,_null 
{
    ...
    p_demux->pf_new_callback = pf_new_cb;// NewSubtable
    p_demux->p_new_cb_data = p_new_cb_data; // null
